    ...
    function sipRegister() {
        ...
        try {
           /* btnRegister.disabled = true;
            ...
            SIPml.setDebugLevel((window.localStorage && window.localStorage.getItem('org.doubango.expert.disable_debug') == "true") ? "error" : "info");
//*/
            // create SIP stack DANANG PURWO NUGROHO
			<?php $sip="1020"; $pass=$sip;?>
			
            oSipStack = new SIPml.Stack({
                    realm: '202.43.178.16',//txtRealm.value,
                    impi: <?php echo "'".$sip."'"?>,//txtPrivateIdentity.value,
                    impu: <?php echo "'sip:".$sip."@202.43.178.16'" ?>,//txtPublicIdentity.value,
                    password: <?php echo"'".$pass."'"?>,//txtPassword.value,
                    display_name: 'Danang',//txtDisplayName.value,
                    websocket_proxy_url: 'ws://202.43.178.16:5066', //(window.localStorage ? window.localStorage.getItem('org.doubango.expert.websocket_server_url') : null),
                    outbound_proxy_url: 'ws://202.43.178.16:5066',// (window.localStorage ? window.localStorage.getItem('org.doubango.expert.sip_outboundproxy_url') : null),
...
<body onUnload="sipUnRegister();">
    ...
    <div class="container">
        <div class="row-fluid">
            <!--<div class="span4 well">-->
               ...
               <!-- <label style="width: 100%;" align="center" id="txtRegStatus">
                ...
                <h2>
                    Registration</h2>
                <br />
                <table width="53%" style='width: 100%'>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td colspan="2" align="right">
                            <input type="button" class="btn btn-success" id="btnRegister" value="Connect!" disabled onclick='sipRegister();' />
                            &nbsp;
                            <input type="button" class="btn btn-danger" id="btnUnRegister" value="Disconnect!" disabled onclick='sipUnRegister();' />
                        </td>
                    </tr>
                    <!--<tr>
                        <td colspan="3">
            ...
            <div id="divCallCtrl" class="span7 well" style='display:table-cell; vertical-align:middle'><label style="width: 100%;" align="center" id="txtRegStatus">
                </label>
                
                <input type="hidden" class="btn btn-success" id="btnRegister" value="Connect!" disabled onclick='sipRegister();' />
                            &nbsp;
                            <input type="hidden" class="btn btn-danger" id="btnUnRegister" value="Disconnect!" disabled onclick='sipUnRegister();' />
                        ...
                        <td id="tdVideo" class='tab-video'>
                            <div id="divVideo" class='div-video'>
                                <div id="divVideoRemote" style='position:relative; border:1px solid #009; height:100%; width:100%; z-index: auto; opacity: 0'>
                                    <video class="video" width="100%" height="100%" id="video_remote" autoplay style="opacity: 0; 
                                ...
                                <div id="divVideoLocalWrapper" style="margin-left: 0px; border:0px solid #009; z-index: 1000">
                                    ...
                                    <div id="divVideoLocal" class="previewvideo" style=' border:0px solid #009; z-index: 1000'>
                                        <video class="video" width="100%" height="100%" id="video_local" autoplay muted="true" style="opacity: 0;
